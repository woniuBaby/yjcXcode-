...
- 支持框架: arm64 / armv7 /模拟器 x86_64 / 模拟器arm64

### 三 API列表

- 3.1 zego的完整api使用说明参考

  https://doc-zh.zego.im/article/1802
...
onReceiveCustomCommand:(NSString *)fromUserID userName:(NSString *)fromUserName content:(NSString*)content roomID:(NSString *)roomID   收到自定义信令
 ...
 */
  setAudioSource:(ZegoAPIExternalAudioDeviceSourceType)source channel:(ZegoAPIPublishChannelIndex)publishChannel;
